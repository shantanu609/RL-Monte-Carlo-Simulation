...
class GraphicDisplay(tk.Tk):
    def __init__(self, value_iteration):
        ...
        self.text_reward(0, 7, "R : 1.0")
        self.text_reward(0, 0, "R : -1.0")
        self.text_reward(0, 4, "R : -1.0")
        self.text_reward(3, 2, "R : -1.0")
        self.text_reward(0, 0, "R : -1.0")
        self.text_reward(5, 6, "R : -1.0")
    ...
    def load_images(self):
        ...
        return (up, down, left, right), (yellow_triange, black_square, green_square, red_square)
    ...
    def reset(self):
        self.update()
        time.sleep(0.5)
        self.canvas.delete(self.yellow_square)
        return self.canvas.coords(self.yellow_square)
    ...
    def rectangle_move(self, action):
        ...
        self.canvas.move(self.yellow_square, base_action[0],
                         base_action[1])  # move agent

    def find_rectangle(self):
        temp = self.canvas.coords(self.yellow_square)
        x = (temp[0] / 100) - 0.5
        y = (temp[1] / 100) - 0.5
        return int(y), int(x)
...
class Env:
    def __init__(self):
        ...
        self.reward[0][7] = 1  # reward 1 for circle
        self.reward[0][0] = -1  # reward -1 for triangle
        self.reward[0][4] = -1  # reward -1 for triangle
        self.reward[3][2] = -1  # reward -1 for triangle
        self.reward[5][6] = -1  # reward -1 for triangle
