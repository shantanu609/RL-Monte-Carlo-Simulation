...
class GraphicDisplay(tk.Tk):
    ...
    def load_images(self):
        yellow_triange = PhotoImage(
            # Image.open("/Users/shantanushinde/Documents/Python_WorkSpace/219_FinalProject/img/triange.png").resize((65,65))
...
class Env:
    def __init__(self):
        ...
        self.reward[0][7] = 1  # reward 1 for green/Goal
        self.reward[0][0] = -1  # reward -1 for trap
        self.reward[2][3] = -1 # reward -1 for trap
        self.reward[6][5] = -1  # reward -1 for trap
